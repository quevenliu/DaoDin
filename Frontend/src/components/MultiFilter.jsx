...
export default function Filter({
  ...
  return (
    <div className="fixed top-0 left-0 w-screen h-screen bg-black/50 flex items-center z-[999]">
      <div className="overflow-y-scroll max-w-[98%] max-h-[98%] w-fit py-5 px-6 md:px-8 md:py-7 m-auto bg-white rounded-[20px] ">
        <div className="mb-3 lg:mb-5">
          <p className="text-[22px] md:text-2xl font-bold mb-1.5 md:mb-3">
            Location
          </p>
          <div className="flex text-lg lg:text-xl items-center mb-2">
            <p className="mr-3 shrink-0">北部</p>
          ...
          <div className="flex text-lg lg:text-xl items-center mb-2">
            <p className="mr-3 shrink-0">中部</p>
            <div className="flex flex-wrap gap-1.5">
              <button
                type="button"
                className={`${
          ...
          <div className="flex text-lg lg:text-xl items-center mb-2">
            <p className="mr-3 shrink-0">南部</p>
            <div className="flex flex-wrap gap-1.5">
              <button
                type="button"
                className={`${
          ...
          <div className="flex text-lg lg:text-xl items-center mb-2">
            <p className="mr-3 shrink-0">東部</p>
            <div className="flex flex-wrap gap-1.5">
              <button
                type="button"
                className={`${
          ...
          <div className="flex text-lg lg:text-xl items-center mb-2">
            <p className="mr-3 shrink-0">其他</p>
            <div className="flex flex-wrap gap-1.5">
              <button
                type="button"
                className={`${
        ...
        <div>
          ...
          <div className="flex text-lg lg:text-xl items-center mb-2">
            <p className="mr-3 shrink-0">戶外</p>
            <div className="flex flex-wrap gap-1.5">
              <button
                type="button"
                className={`${
          ...
          <div className="flex text-lg lg:text-xl items-center mb-2">
            <p className="mr-3 shrink-0">運動</p>
            <div className="flex flex-wrap gap-1.5">
              <button
                type="button"
                className={`${
          ...
          <div className="flex text-lg lg:text-xl items-center mb-2">
            <p className="mr-3 shrink-0">藝文</p>
            <div className="flex flex-wrap gap-1.5">
              <button
                type="button"
                className={`${
          ...
          <div className="flex text-lg lg:text-xl items-center mb-2">
            <p className="mr-3 shrink-0">學習</p>
            <div className="flex flex-wrap gap-1.5">
              <button
                type="button"
                className={`${
          ...
          <div className="flex text-lg lg:text-xl items-center mb-2">
            <p className="mr-3 shrink-0">遊戲</p>
            <div className="flex flex-wrap gap-1.5">
              <button
                type="button"
                className={`${
          ...
          <div className="flex text-lg lg:text-xl items-center mb-2">
            <p className="mr-3 shrink-0">休閒</p>
            <div className="flex flex-wrap gap-1.5">
              <button
                type="button"
                className={`${
          ...
          <div className="flex text-lg lg:text-xl items-center mb-2">
            <p className="mr-3 shrink-0">飲食</p>
            <div className="flex flex-wrap gap-1.5">
              <button
                type="button"
                className={`${
          ...
          <div className="flex mt-5">
            <button
              ...
              className="flex w-20 lg:w-28 justify-center h-10 lg:py-1.5 items-center mr-auto text-xl lg:text-[22px] font-bold bg-[#BFBFBF] rounded-[50px] text-white"
            >
              Clear
            </button>
            ...
            <button
              ...
              className="flex w-24 lg:w-28 justify-center items-center lg:py-1.5 h-10 text-[22px] font-bold bg-[#BFBFBF] rounded-[50px] text-white mr-1.5 lg:mr-3"
            >
              Cancel
            </button>
            <button
              ...
              className="flex w-24 lg:w-28 justify-center items-center h-10 lg:py-1.5 text-[22px] font-bold bg-primaryColor dark:bg-darkPrimaryColor rounded-[50px] text-white"
            >
              Apply
            </button>
          </div>
