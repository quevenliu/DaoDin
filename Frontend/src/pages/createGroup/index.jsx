            ...
            <form className="px-2.5 mb-2 lg:mb-6 flex flex-col justify-between gap-3.5 md:gap-4 lg:gap-4.5">
                ...
                >
                  {({ open }) => (
                    <>
                      ...
                      <div className="relative md:mt-2 mt-1.5">
              ...
              >
                ...
                <textarea
                  ...
                  rows="4"
                  className="mt-1 md:mt-1.5 px-4 py-2 lg:px-4.5 text-lg lg:text-xl font-normal border border-solid border-primaryColor dark:border-darkPrimaryColor ring-1 ring-inset ring-primaryColor dark:ring-darkPrimaryColor focus:outline-none focus:ring-2 focus:ring-primaryColor dark:focus:ring-darkPrimaryColor rounded-[20px] resize-none overflow-hidden"
