        ...
        <div className="w-[90%] max-w-5xl bg-white m-auto mb-10 px-12 py-8 rounded-b-[20px] flex">
          <form className="w-full px-2.5 mb-6 flex flex-col justify-between gap-5">
            ...
            <div className="self-end flex gap-3">
              <button
                type="button"
                className="w-32 py-2 text-center text-2xl font-semibold text-white bg-[#BFBFBF] rounded-[50px] focus:outline-none focus:ring-2 focus:ring-primaryColor dark:focus:ring-darkPrimaryColor hover:animate-buttonPush"
              ...
              <button
                type="button"
                className="w-32 py-2 text-center text-2xl font-semibold text-white bg-primaryColor dark:bg-darkPrimaryColor rounded-[50px] focus:outline-none focus:ring-2 focus:ring-primaryColor dark:focus:ring-[#BFBFBF] hover:animate-buttonPush"
