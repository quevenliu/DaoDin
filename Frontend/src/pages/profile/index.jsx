...
export default function ProfilePage({ token, userId }) {
  ...
  return (
    <>
      ...
      <Topbar token={token} />
      <div
        className={`${styles.content} min-h-screen bg-backgroundColor dark:bg-darkBackgroundColor p-12`}
      >
        <div className="group w-[90%] max-w-5xl flex gap-7 bg-white m-auto mb-7 px-12 py-8 rounded-[20px] flex relative">
          ...
          <div className="w-full">
            ...
            <p
              className={`${styles.content} w-full px-6 py-4 min-h-[100px] text-xl bg-backgroundColor dark:text-darkPrimaryColor rounded-[20px]`}
            >
            ...
            <div className="flex">
              <button
                ...
                className={`${styles.content} h-16 ${
                  ...
                  text-[26px] font-bold px-6 rounded-t-[20px] flex items-center dark:border-t dark:border-l dark:border-r dark:border-solid dark:border-white`}
